...
{
    setTimeout(() => {document.documentElement.style.setProperty('--bg', 'antiquewhite');
...
function cleanupScene8()
{
    ...
    setTimeout(() => {document.documentElement.style.setProperty('--bg', 'var(DelftBlue)');
    ...
    lines.forEach(line => {
        ...
        tokens.forEach(token => {
          ...
          if(token == "control")
          {
            ...
            span.classList.add('poem-scene-8', 'scene-8');
